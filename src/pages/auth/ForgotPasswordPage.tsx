      ...
      <div className="max-w-md w-full bg-white rounded shadow-2xl relative overflow-hidden transform transition-all animate-in zoom-in duration-300">
        ...
        <div className="p-4">
          <div className="flex flex-col items-center text-center mb-8">
            <div className="p-3 bg-teal-50 rounded-full mb-3 shadow-inner">
              <Mail className="text-[#1e695e]" size={32} />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 bg-[#1e695e] hover:bg-[#164e46] text-white font-bold py-1.5 rounded shadow-md hover:shadow-teal-900/30 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:bg-gray-300 disabled:shadow-none"
            >
              {loading ? (
                <>
          ...
          <div className="mt-3 text-center border-t border-gray-100 pt-4">
            <Link
              to="/login"
              className="inline-flex items-center gap-2 text-[10px] font-bold text-gray-400 hover:text-[#1e695e] transition-all uppercase tracking-widest"
            >
