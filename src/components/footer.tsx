          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-4">
              {[
                ...
                <div
                  key={index}
                  className={`p-2 rounded-full bg-teal-800/50 ${color} cursor-pointer transition-all duration-300`}
                >
          ...
          <div className="space-y-5">
            ...
            <div className="text-[14px] space-y-3 leading-relaxed text-teal-50/90">
              <p className="font-semibold text-white">
                हाम्रो कार्यालय शिक्षक मासिक, ज्ञान-विज्ञान शैक्षिक सहकारी
                संस्था लिमिटेड
              </p>
              <div className="space-y-1 opacity-80">
                <p>घर नं. ४११, टीकामार्ग झम्सीखेल, ललितपुर</p>

                <p>
                  फोन :{" "}
                  <a
                    href="tel:015448142"
                    className="hover:text-[#ff3c02] transition-colors"
                  >
                    ०१-५४४८१४२
                  </a>
                  ,{" "}
                ...
                <p>
                  <a
                    href="mailto:mail@teacher.org.np"
                    className="hover:text-[#ff3c02] transition-colors cursor-pointer"
                  >
                    mail@teacher.org.np
                  </a>
                </p>
            ...
            <ul className="space-y-2 text-[14px]">
              {[
                ...
                >
                  ...
                  <span className="group-hover:text-[#ff3c02] transition-colors">
                    {link}
                  </span>
                </li>
              ))}
          ...
          <div className="flex flex-col justify-between h-full space-y-8">
            <div className="space-y-4">
              ...
              <img
                src="/google.png"
                alt="Google Play"
                className="h-12 w-auto cursor-pointer hover:opacity-80 transition-opacity border border-teal-700 rounded-lg p-1"
              />
            </div>
            <div className="space-y-4">
              <p className="text-sm font-bold text-white uppercase">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs md:text-sm text-center ">
            ...
            <span className="text-white font-medium">
              Shikshak Monthly Magazine
            </span>
            . All rights reserved.
          </p>
          <div className="flex items-center gap-2 text-xs md:text-sm">
            <span>Developed by:</span>
            <Link to={"/sempatech.com"}>
              <span className="text-[#217367] font-bold hover:text-teal-300 cursor-pointer transition-colors">
                Shempa Tech
              </span>
            </Link>
          </div>
