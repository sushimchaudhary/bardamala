  ...
  return (
    <div className="bg-gray-50 w-full font-sans">
      <div className="max-w-7xl mx-auto p-4">
        <div className="mb-2">
          <span className="bg-[#1e695e] text-white px-5 py-3 font-bold text-md border-l-10 border-[#e44d26]">
            रिपोर्ट
          </span>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-9 border-t-2 border-gray-200">
          <div className="lg:col-span-6 relative h-[25vh] md:h-[40vh] lg:h-auto overflow-hidden border-x border-gray-200 bg-gray-200">
            {reportImages.map((img, index) => (
              ...
              >
                <img
                  ...
                  alt={`Report ${index}`}
                  className="w-full   
                 w-[300px]      /* Mobile ko lagi height */
                 sm:h-[400px]   /* Small screens (tablets) */
                 md:h-[500px]   /* Medium screens (laptops) */
                 lg:h-[600px]   /* Large screens (desktops) */
                 xl:h-full      /* Ekdam thulo screen ma full height */"
                />
              </div>
            ))}
